...
const [users, setUsers] = useState([{}]) // Step 1: First, let's create a place (state) to save the users from our API.

const [newUserName, setNewUserName] = useState('')
const [newUserJobTitle,setnewUserJobTitle] = useState('')
const [newUserCompanyName, setnewUserCompanyName] = useState('')

// Create 3 new variables with useState() like we did for POST, but for UPDATE:
//  *         updatedName, updatedJobTitle, and updatedCompanyName
...
function updateUser(e, userObject){
  ...
  return (
    ...
    <form className='userHead'>
      ...
      <label>Name</label>
      <input onChange={(e) => setNewUserName(e.target.value)} placeholder='Enter New Name'></input>

      <label>Job Title</label>
      <input onChange={(e) => setnewUserJobTitle(e.target.value)} placeholder='Enter New Job Title'></input>

      <label>Company Name</label>
      <input onChange={(e) => setnewUserCompanyName(e.target.value)} placeholder='Enter New Company Name'></input>
